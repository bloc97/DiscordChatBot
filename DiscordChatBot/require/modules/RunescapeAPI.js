...
class RsApiMod {
    ...
    constructor(debug) {
        ...
        this.command = "runes"; //Command that activates this module
...
const returnOldInfo = function(info, message, playername) {
...
const returnInfo = function(info, message, playername) {
    const skills = info.skills;
    const oskills = skills.overall;
